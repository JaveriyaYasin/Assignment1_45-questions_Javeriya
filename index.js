...
const quote = "The best among you are those who have the best manners and character.";
const author = "Prophet Muhammad (PBUH)";
console.log(`${author} once said, "${quote}"`);
console.log("//--------------------------------5-----------------------------------------------");
//Question 5: Famous Quote 
const quote1 = "The best among you are those who have the best manners and character.";
const famous_person = "Prophet Muhammad (PBUH)";
const message = `${famous_person} once said, "${quote1}"`;
console.log(message);
console.log("//---------------------------------6----------------------------------------------");
//Question 6: use of \t \n and stripped
...
console.log("//-----------------------------------11--------------------------------------------");
const friendsnames = ["I", "Me", "Myself"];
...
console.log("//-----------------------------------15--------------------------------------------");
let guests = ["Mother", "Sister", "Myself"];
...
//Question 18
console.log("//-----------------------------------18--------------------------------------------");
let placesToVisit = ['Makkah', 'Medina', 'Turkey', 'Canada', 'Switzerland'];
...
console.log("//-----------------------------------20--------------------------------------------");
let things = ['Wah Cantt', 'K2', 'AnsuLake', 'Joyland'];
...
//Question 30
console.log("//-----------------------------------30--------------------------------------------");
const usernames = ["guest", "administrator", "user", "root", "admin"];
...
function make_greet(greet_name) {
    greeting = greet_name.map((value) => (`Greet ${value}`));
    return greeting;
}
